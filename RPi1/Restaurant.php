...
function determineStayID($ChipID){
    $staysWithThisChipID = dbafrage();  // TODO
	//1. Abfrage auf Aufenthalt mit "where chip_id=$ChipID and auf_abfahrt is null"
	//2. Abfrage auf Aufenthalt mit "where chip_id=$ChipID" + foreach über Ergebnismenge
...
//Insert into einkauf (ein_id, auf_id, ver_id, ein_betrag, ein_menge) values (null, $stayID, $orderItem["id"], $orderItem["preis"], $orderItem["count"])
}
