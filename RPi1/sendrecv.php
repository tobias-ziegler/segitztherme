...
// Damit dieses Programm läuft, muss auf dem Server (Raspberry Pi) vorher das
// Programm sockserver.py gestartet werden!!
...
if (!isset($_SESSION['CONNECT'])) {
    ...
    $con = new CRaspberrySR('192.168.30.12', '9020');
...
<H4>(C) C. Kilgenstein, 07/2019 <BR><BR>
    <U>Hinweis:</U> Auf dem Raspberry Pi muss das Programm sockserver.py gestartet werden!</H4>
